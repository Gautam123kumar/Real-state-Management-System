...
<body onLoad="init()" style="background-color:#33f2b6">
<form name="frm" action="saveCurrency.jsp" onSubmit="return validate()">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td colspan="3"><h3>Add Currency</h3></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>Currency  Name</td>
    <td><input type="text" name="sCurrencyName" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
   ...
   <tr>
    ...
    <td><input type="text" name="sSymbol" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
