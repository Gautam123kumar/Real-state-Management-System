...
<body onload="init()"background="images1/3.jpg">
  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" >
      <tr>         
        ...
        <td width="75%" valign="top"><table width="50%  border="0" cellspacing="0" cellpadding="0" bgcolor="#b9c7ed">
  <tr>
   <td colspan="2" valign="top"><%=nullconv((String)request.getAttribute("error"))%></td>
	...
	<tr>
      <td colspan="2"align="center"><h4>Business Information</h4></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td colspan="2" align="center"><h4>Personal Information</h4></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
	...
	<tr>
  <td colspan="2" align="center" valign="top"><h4>User Login Information</h4></td>
  </tr>
<tr>
    <td width="22%">&nbsp;</td>
    <td width="78%">&nbsp;</td>
   ...
   <tr>
    <td align="center">Create Username </td>
