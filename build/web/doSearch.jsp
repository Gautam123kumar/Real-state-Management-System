...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
    <td colspan="2"><h5 style="color: #0cfaea; font-size: 20px; font-weight: bold">SEARCH YOUR PROPERTY</h5></td>
  </tr>
  <tr>
    <td width="23%">&nbsp;</td>
    <td width="77%">&nbsp;</td>
  ...
  <tr>
    <td style="color: white; font-size: 12px; font-weight: bold">Transaction Type:</td>
  ...
  <tr>
    <td style="color: white; font-size: 12px; font-weight: bold"> Property Type</td>
  ...
  <tr>
    <td style="color: white; font-size: 12px; font-weight: bold"> City:<br /></td>
  ...
  <tr>
    <td style="color: white; font-size: 12px; font-weight: bold"> Location:<br /></td>
  ...
  <tr>
    <td style="color: white; font-size: 12px; font-weight: bold"> Budget:</td>
    <td>
<select name="budget">
  ...
  <tr>
    <td style="color: white; font-size: 12px; font-weight: bold">Minimum Bedroom:</td>
