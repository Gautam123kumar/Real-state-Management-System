...
<body background="images1/14.jpg">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td colspan="2" valign="top"><h3 style="color: #0cfaea; font-size: 20px; font-weight: bold">Post Your Requirement</h3></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td style="color: white; font-size: 15px; font-weight: bold">Transaction Type: </td>
  ...
  <tr>
    <td style="color: white; font-size: 15px; font-weight: bold">Property Type: </td>
  ...
  <tr>
    <td style="color: white; font-size: 15px; font-weight: bold">City:</td>
  ...
  <tr>
    <td style="color: white; font-size: 15px; font-weight: bold">Locality:</td>
  ...
  <tr>
    <td style="color: white; font-size: 15px; font-weight: bold">Area:</td>
    <td><input type="text" name="iArea" onKeyPress="return isNumberKey(event)"placeholder="in Sq.ft."/></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td style="color: white; font-size: 15px; font-weight: bold">Budget:</td>
    <td>
  ...
  <tr>
    <td style="color: white; font-size: 15px; font-weight: bold">Bedroom:</td>
  ...
  <tr>
    <td style="color: white; font-size: 15px; font-weight: bold">Floor Number: </td>
