...
<body background="images1/31.jpg">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <tr>
      <td colspan="2"><h2 style="color:#f5ff44; font-size: 20px; font-weight: bold">My Profile </h2></td>
    </tr>
    
    <tr>
      <td colspan="2"><h3 style="color: #f5ff44; font-size: 20px; font-weight: bold">My Information</h3></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td style="color:#ef5347; font-size: 15px; font-weight: bold">First Name: </td>
    ...
    <tr>
      <td style="color: #ef5347; font-size: 15px; font-weight: bold">Last Name: </td>
    ...
    <tr>
      <td style="color: #ef5347; font-size: 15px; font-weight: bold">City:</td>
    ...
    <tr>
      <td style="color: #ef5347; font-size: 15px; font-weight: bold">Location:</td>
    ...
    <tr>
      <td style="color: #ef5347; font-size: 15px; font-weight: bold">E-mail:</td>
    ...
    <tr>
      <td style="color: #ef5347; font-size: 15px; font-weight: bold">Date of Birth: (DD Month YYYY) </td>
    ...
    <tr>
      <td style="color:#ef5347; font-size: 15px; font-weight: bold">Gender:</td>
    ...
    <tr>
      <td style="color: #ef5347; font-size: 15px; font-weight: bold">Contact No: </td>
