...
<body background="images1/51.jpg">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td colspan="2" valign="top"><h5 style="color: white; font-size: 20px; font-weight: bold">List Your Property</h5></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td style="font-size: 15px; font-weight: bold">Transaction Type: </td>
  ...
  <tr>
    <td style="font-size: 15px; font-weight: bold">Property Type: </td>
  ...
  <tr>
    <td style="font-size: 15px; font-weight: bold">Property Address: </td>
  ...
  <tr>
    <td style="font-size: 15px; font-weight: bold">City:</td>
  ...
  <tr>
    <td style="font-size: 15px; font-weight: bold">Locality:</td>
  ...
  <tr>
    <td style="font-size: 15px; font-weight: bold">Area:</td>
    <td><input type="text" name="iArea" onKeyPress="return isNumberKey(event)" placeholder="in Sq.ft."/>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><input type="text" name="iTotalPrice" onKeyPress="return isNumberKey(event)" placeholder="in &#8377"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </td>
  </tr>
  <tr> 
    <td>&nbsp;</td>
  ...
  <tr>
    <td style="font-size: 15px; font-weight: bold">Is the price negotiable? </td>
  ...
  <tr>
    <td style="font-size: 15px; font-weight: bold">Bedroom:</td>
  ...
  <tr>
    <td style="font-size: 15px; font-weight: bold">Floor Number: </td>
